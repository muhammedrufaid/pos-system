    ...
    return (
        <div className='w-[450px] bg-[#262626] p-4 rounded-lg mb-4'>
            <div className='flex items-center gap-5'>
                ...
                <div className='flex items-center justify-between w-[100%]'>
                    <div className='flex flex-col items-start gap-1'>
                        <h1 className='text-[#f5f5f5] font-semibold text-lg tracking-wide'>Ameer Mohamed</h1>
            ...
            <div className='flex justify-between items-center mt-4 text-[#ababab]'>
                <p>Januray 25, 2026 08:32 PM</p>
                <p>8 Items</p>
            </div>
            <hr className='w-full mt-4 border-t-1 border-gray-500' />
            <div className='flex items-center justify-between mt-4'>
                <h1 className='text-[#f5f5f5] text-lg font-semibold'>Total</h1>
                <p className='text-[#f5f5f5] text-lg font-semibold'>100 AED</p>
            </div>
        </div>
    )
}
